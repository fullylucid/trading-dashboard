        ...
        <div className="bg-gray-800/50 rounded p-3 border border-gray-700">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <div className="text-white font-mono">
                {formatBigNumber(item.quote?.volume)}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800/50 rounded p-3 border border-gray-700">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                <div className="text-white font-mono">
                  {formatScore(item.signals_summary?.technical?.score)}
                </div>
                <div className="text-gray-400 text-xs">
                  {item.signals_summary?.technical?.reason || '—'}
                </div>
              </div>
              <div>
                <div className="text-white font-mono">
                  {formatScore(item.signals_summary?.projection?.score)}
                </div>
                <div className="text-gray-400 text-xs">
                  {item.signals_summary?.projection?.reason || '—'}
                </div>
              </div>
              <div>
                <div className="text-white font-mono">
                  {formatScore(item.signals_summary?.narrative?.score)}
                </div>
                <div className="text-gray-400 text-xs">
                  {item.signals_summary?.narrative?.reason || '—'}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-800/50 rounded p-3 border border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              ...
              <div className="text-white font-mono">
                {formatPercent(item.pct_of_portfolio)}
              </div>
            </div>
          </div>
        </div>
                        ...
                        <React.Fragment key={item.symbol}>
                          <tr className="hover:bg-gray-600/50">
                            ...
                            <td className="py-3 px-4 font-mono">
                              {formatScore(item.scores?.technical)}
                            </td>
                            <td className="py-3 px-4 font-mono">
                              {formatScore(item.scores?.projection)}
                            </td>
                            <td className="py-3 px-4 font-mono">
                              {formatScore(item.scores?.narrative)}
                            </td>
                            <td className="py-3 px-4">
                              <button 
